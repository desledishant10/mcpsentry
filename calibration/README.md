...
5. **Aggregate.** Once 3+ targets are labeled, run `mcp-witness-eval-calibration --all` for cross-target precision/recall. The per-tool diffs list the actionable gaps.
